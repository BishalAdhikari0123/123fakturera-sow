...
function getDefaultEnglishTerms() {
  return ` <p><b>By</b> clicking Invoice Now, you choose to register according to the information that you have typed in and the text on the registration page and the terms here, and you at the same time accept the terms here.</p>

  <p>You can use the program <strong>FOR FREE</strong> for 14 days.</p>
  ...
  <p>The introductory offer (SEK 99 per month) is for the annual fee Start for the first year. After the first year, the ordinary price is billed, which is currently, for annual fee Start, <strong>SEK 159 per month</strong>, for annual fee Remote control, <strong>SEK 300 per month</strong> and for annual fee Pro, <strong>SEK 333 per month</strong>. After one year, the annual Remote Control fee is invoiced as standard, but you can choose Start or Pro by giving notice at any time before the due date.</p>
  ...
  <p><strong>Click on Invoice Now</strong> to register according to the information you have entered and the terms here. (Date and time of admission are entered automatically in our registers.)</p>
...
function getDefaultSwedishTerms() {
  return `<p><strong>GENOM ATT</strong> klicka på Fakturera Nu så väljer ni att registrera enligt den information som ni har lagt in och texten på registrerings sidan och villkoren här, och accepterar samtidigt villkoren här.</p>

  <p>Ni kan använda programmet <strong>GRATIS</strong> i 14 dagar.</p>
  ...
  <p><strong>Klicka på Fakturera Nu</strong> för att registrera i enlighet med den information som ni har lagt in och villkoren här. (Datum och tidpunkt för inläggningen läggs in automatiskt i våra register.)</p>
  ...
  <p><strong>Ha en trevlig dag!</strong></p>
  `;
}