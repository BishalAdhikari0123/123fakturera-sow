      ...
      <div className="header-container">
        <div className="header-left">
          <button onClick={toggleMenu} className="menu-button" aria-label="Menu">
            {isMenuOpen && showSidebar ? <X size={24} /> : <Menu size={24} />}
          </button>
        ...
        <div className="header-right">
          <button onClick={toggleLanguage} className="language-button">
            ...
            <img
              src={`/flag-images/${i18n.language === 'en' ? 'GB.png' : 'SE.png'}`}
        ...
        <div className={`mobile-menu ${isMenuOpen ? 'visible' : 'hidden'}`}>
          ...
          <nav className="mobile-menu-nav">
            <ul className="mobile-menu-list">
              ...
              <li>
                <Link to="/terms" className="mobile-menu-link" onClick={toggleMenu}>
                  Terms & Conditions
                </Link>
              </li>
            </ul>
